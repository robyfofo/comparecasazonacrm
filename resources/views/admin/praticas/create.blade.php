...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.pratica.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.praticas.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="pratica">{{ trans('cruds.pratica.fields.pratica') }}</label>
                <input class="form-control {{ $errors->has('pratica') ? 'is-invalid' : '' }}" type="text" name="pratica" id="pratica" value="{{ old('pratica', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('immobile') ? 'is-invalid' : '' }}" name="immobile_id" id="immobile_id" required>
                    @foreach($immobiles as $id => $immobile)
                        <option value="{{ $id }}" {{ old('immobile_id') == $id ? 'selected' : '' }}>{{ $immobile }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('stato') ? 'is-invalid' : '' }}" name="stato" id="stato" required>
                    ...
                    @foreach(App\Pratica::STATO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('stato', '1') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('stato'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('contratto') ? 'is-invalid' : '' }}" name="contratto_id" id="contratto_id" required>
                    @foreach($contrattos as $id => $contratto)
                        <option value="{{ $id }}" {{ old('contratto_id') == $id ? 'selected' : '' }}>{{ $contratto }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prezzo_richiesto') ? 'is-invalid' : '' }}" type="number" name="prezzo_richiesto" id="prezzo_richiesto" value="{{ old('prezzo_richiesto', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('prezzo_note') ? 'is-invalid' : '' }}" name="prezzo_note" id="prezzo_note">{!! old('prezzo_note') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spese_condominio') ? 'is-invalid' : '' }}" type="text" name="spese_condominio" id="spese_condominio" value="{{ old('spese_condominio', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('consegna') ? 'is-invalid' : '' }}" name="consegna_id" id="consegna_id">
                    @foreach($consegnas as $id => $consegna)
                        <option value="{{ $id }}" {{ old('consegna_id') == $id ? 'selected' : '' }}>{{ $consegna }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('data_consegna') ? 'is-invalid' : '' }}" type="text" name="data_consegna" id="data_consegna" value="{{ old('data_consegna', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('notaio_tasse') ? 'is-invalid' : '' }}" name="notaio_tasse" id="notaio_tasse">{!! old('notaio_tasse') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('spese_accessori') ? 'is-invalid' : '' }}" name="spese_accessori" id="spese_accessori">{!! old('spese_accessori') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('contratto_tipo') ? 'is-invalid' : '' }}" name="contratto_tipo_id" id="contratto_tipo_id">
                    @foreach($contratto_tipos as $id => $contratto_tipo)
                        <option value="{{ $id }}" {{ old('contratto_tipo_id') == $id ? 'selected' : '' }}>{{ $contratto_tipo }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('prezzo_nascondi') ? 'is-invalid' : '' }}" name="prezzo_nascondi" id="prezzo_nascondi">
                    ...
                    @foreach(App\Pratica::PREZZO_NASCONDI_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('prezzo_nascondi', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('tipo_mandato') ? 'is-invalid' : '' }}" name="tipo_mandato_id" id="tipo_mandato_id">
                    @foreach($tipo_mandatos as $id => $tipo_mandato)
                        <option value="{{ $id }}" {{ old('tipo_mandato_id') == $id ? 'selected' : '' }}>{{ $tipo_mandato }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('mandato_agente') ? 'is-invalid' : '' }}" name="mandato_agente_id" id="mandato_agente_id">
                    @foreach($mandato_agentes as $id => $mandato_agente)
                        <option value="{{ $id }}" {{ old('mandato_agente_id') == $id ? 'selected' : '' }}>{{ $mandato_agente }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('mandato_inizio') ? 'is-invalid' : '' }}" type="text" name="mandato_inizio" id="mandato_inizio" value="{{ old('mandato_inizio') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('mandato_fine') ? 'is-invalid' : '' }}" type="text" name="mandato_fine" id="mandato_fine" value="{{ old('mandato_fine') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('mandato_rinnovo') ? 'is-invalid' : '' }}" type="text" name="mandato_rinnovo" id="mandato_rinnovo" value="{{ old('mandato_rinnovo') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('in_home') ? 'is-invalid' : '' }}" name="in_home" id="in_home">
                    ...
                    @foreach(App\Pratica::IN_HOME_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('in_home', '1') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('sul_sito') ? 'is-invalid' : '' }}" name="sul_sito" id="sul_sito">
                    ...
                    @foreach(App\Pratica::SUL_SITO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('sul_sito', '1') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('nascondi_foto') ? 'is-invalid' : '' }}" name="nascondi_foto" id="nascondi_foto">
                    ...
                    @foreach(App\Pratica::NASCONDI_FOTO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('nascondi_foto', '1') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('newsletter') ? 'is-invalid' : '' }}" name="newsletter" id="newsletter">
                    ...
                    @foreach(App\Pratica::NEWSLETTER_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('newsletter', '0') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <label for="scadenza_incarico_alert_id">{{ trans('cruds.pratica.fields.scadenza_incarico_alert') }}</label>
                <select class="form-control select2 {{ $errors->has('scadenza_incarico_alert') ? 'is-invalid' : '' }}" name="scadenza_incarico_alert_id" id="scadenza_incarico_alert_id">
                    @foreach($scadenza_incarico_alerts as $id => $scadenza_incarico_alert)
                        <option value="{{ $id }}" {{ old('scadenza_incarico_alert_id') == $id ? 'selected' : '' }}>{{ $scadenza_incarico_alert }}</option>
                    @endforeach
                </select>
                @if($errors->has('scadenza_incarico_alert'))
                    <span class="text-danger">{{ $errors->first('scadenza_incarico_alert') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.pratica.fields.scadenza_incarico_alert_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="inizio_affitto">{{ trans('cruds.pratica.fields.inizio_affitto') }}</label>
                <input class="form-control date {{ $errors->has('inizio_affitto') ? 'is-invalid' : '' }}" type="text" name="inizio_affitto" id="inizio_affitto" value="{{ old('inizio_affitto') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('scadenza_affitto') ? 'is-invalid' : '' }}" type="text" name="scadenza_affitto" id="scadenza_affitto" value="{{ old('scadenza_affitto') }}">
            ...
            <div class="form-group">
                <label for="scadenza_affitto_alert_id">{{ trans('cruds.pratica.fields.scadenza_affitto_alert') }}</label>
                <select class="form-control select2 {{ $errors->has('scadenza_affitto_alert') ? 'is-invalid' : '' }}" name="scadenza_affitto_alert_id" id="scadenza_affitto_alert_id">
                    @foreach($scadenza_affitto_alerts as $id => $scadenza_affitto_alert)
                        <option value="{{ $id }}" {{ old('scadenza_affitto_alert_id') == $id ? 'selected' : '' }}>{{ $scadenza_affitto_alert }}</option>
                    @endforeach
                </select>
                @if($errors->has('scadenza_affitto_alert'))
                    <span class="text-danger">{{ $errors->first('scadenza_affitto_alert') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.pratica.fields.scadenza_affitto_alert_helper') }}</span>
            </div>
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('venduto') ? 'is-invalid' : '' }}" name="venduto" id="venduto">
                    ...
                    @foreach(App\Pratica::VENDUTO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('venduto', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('profitto') ? 'is-invalid' : '' }}" type="number" name="profitto" id="profitto" value="{{ old('profitto', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('profitto_iva') ? 'is-invalid' : '' }}" type="number" name="profitto_iva" id="profitto_iva" value="{{ old('profitto_iva', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data_vendita') ? 'is-invalid' : '' }}" type="text" name="data_vendita" id="data_vendita" value="{{ old('data_vendita') }}">
