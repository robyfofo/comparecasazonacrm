...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.immobile.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.immobiles.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('tipologia_immobile') ? 'is-invalid' : '' }}" name="tipologia_immobile_id" id="tipologia_immobile_id" required>
                    @foreach($tipologia_immobiles as $id => $tipologia_immobile)
                        <option value="{{ $id }}" {{ old('tipologia_immobile_id') == $id ? 'selected' : '' }}>{{ $tipologia_immobile }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prezzo') ? 'is-invalid' : '' }}" type="number" name="prezzo" id="prezzo" value="{{ old('prezzo', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('garage') ? 'is-invalid' : '' }}" name="garage_id" id="garage_id">
                    @foreach($garages as $id => $garage)
                        <option value="{{ $id }}" {{ old('garage_id') == $id ? 'selected' : '' }}>{{ $garage }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mq') ? 'is-invalid' : '' }}" type="text" name="mq" id="mq" value="{{ old('mq', '') }}">
                @if($errors->has('mq'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('cucina') ? 'is-invalid' : '' }}" name="cucina" id="cucina">
                    ...
                    @foreach(App\Immobile::CUCINA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('cucina', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('giardino') ? 'is-invalid' : '' }}" name="giardino" id="giardino">
                    ...
                    @foreach(App\Immobile::GIARDINO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('giardino', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('terrazza') ? 'is-invalid' : '' }}" name="terrazza" id="terrazza">
                    ...
                    @foreach(App\Immobile::TERRAZZA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('terrazza', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('anno_costruzione') ? 'is-invalid' : '' }}" type="text" name="anno_costruzione" id="anno_costruzione" value="{{ old('anno_costruzione', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('anno_ristrutturazione') ? 'is-invalid' : '' }}" type="text" name="anno_ristrutturazione" id="anno_ristrutturazione" value="{{ old('anno_ristrutturazione', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contesto') ? 'is-invalid' : '' }}" type="text" name="contesto" id="contesto" value="{{ old('contesto', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('camere') ? 'is-invalid' : '' }}" type="text" name="camere" id="camere" value="{{ old('camere', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vani') ? 'is-invalid' : '' }}" type="text" name="vani" id="vani" value="{{ old('vani', '') }}">
                @if($errors->has('vani'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ripostigli') ? 'is-invalid' : '' }}" type="text" name="ripostigli" id="ripostigli" value="{{ old('ripostigli', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bagni') ? 'is-invalid' : '' }}" type="text" name="bagni" id="bagni" value="{{ old('bagni', '') }}">
                @if($errors->has('bagni'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('balconi') ? 'is-invalid' : '' }}" type="text" name="balconi" id="balconi" value="{{ old('balconi', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('soffitta') ? 'is-invalid' : '' }}" type="text" name="soffitta" id="soffitta" value="{{ old('soffitta', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cantina') ? 'is-invalid' : '' }}" type="text" name="cantina" id="cantina" value="{{ old('cantina', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('taverna') ? 'is-invalid' : '' }}" type="text" name="taverna" id="taverna" value="{{ old('taverna', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('catasto_sezione') ? 'is-invalid' : '' }}" type="text" name="catasto_sezione" id="catasto_sezione" value="{{ old('catasto_sezione', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('catasto_foglio') ? 'is-invalid' : '' }}" type="text" name="catasto_foglio" id="catasto_foglio" value="{{ old('catasto_foglio', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('catasto_mappale') ? 'is-invalid' : '' }}" type="text" name="catasto_mappale" id="catasto_mappale" value="{{ old('catasto_mappale', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('catasto_sub') ? 'is-invalid' : '' }}" type="text" name="catasto_sub" id="catasto_sub" value="{{ old('catasto_sub', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('catasto_zona') ? 'is-invalid' : '' }}" type="text" name="catasto_zona" id="catasto_zona" value="{{ old('catasto_zona', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('catasto_categoria') ? 'is-invalid' : '' }}" type="text" name="catasto_categoria" id="catasto_categoria" value="{{ old('catasto_categoria', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('catasto_classe') ? 'is-invalid' : '' }}" type="text" name="catasto_classe" id="catasto_classe" value="{{ old('catasto_classe', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('catasto_consvani') ? 'is-invalid' : '' }}" type="text" name="catasto_consvani" id="catasto_consvani" value="{{ old('catasto_consvani', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('catasto_superficie') ? 'is-invalid' : '' }}" type="text" name="catasto_superficie" id="catasto_superficie" value="{{ old('catasto_superficie', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('catasto_rendita') ? 'is-invalid' : '' }}" type="text" name="catasto_rendita" id="catasto_rendita" value="{{ old('catasto_rendita', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('catasto_codcomune') ? 'is-invalid' : '' }}" type="text" name="catasto_codcomune" id="catasto_codcomune" value="{{ old('catasto_codcomune', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('posti_auto') ? 'is-invalid' : '' }}" type="text" name="posti_auto" id="posti_auto" value="{{ old('posti_auto', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('imp_satellite') ? 'is-invalid' : '' }}" type="text" name="imp_satellite" id="imp_satellite" value="{{ old('imp_satellite', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('imp_aria') ? 'is-invalid' : '' }}" type="text" name="imp_aria" id="imp_aria" value="{{ old('imp_aria', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('imp_allarme') ? 'is-invalid' : '' }}" type="text" name="imp_allarme" id="imp_allarme" value="{{ old('imp_allarme', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('riscaldamento') ? 'is-invalid' : '' }}" type="text" name="riscaldamento" id="riscaldamento" value="{{ old('riscaldamento', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('citofono') ? 'is-invalid' : '' }}" type="text" name="citofono" id="citofono" value="{{ old('citofono', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ascensore') ? 'is-invalid' : '' }}" type="text" name="ascensore" id="ascensore" value="{{ old('ascensore', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pan_solari') ? 'is-invalid' : '' }}" type="text" name="pan_solari" id="pan_solari" value="{{ old('pan_solari', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('loggia') ? 'is-invalid' : '' }}" type="text" name="loggia" id="loggia" value="{{ old('loggia', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('veranda') ? 'is-invalid' : '' }}" type="text" name="veranda" id="veranda" value="{{ old('veranda', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('posto_auto') ? 'is-invalid' : '' }}" type="text" name="posto_auto" id="posto_auto" value="{{ old('posto_auto', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pavimenti') ? 'is-invalid' : '' }}" type="text" name="pavimenti" id="pavimenti" value="{{ old('pavimenti', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('infissi') ? 'is-invalid' : '' }}" type="text" name="infissi" id="infissi" value="{{ old('infissi', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facciata') ? 'is-invalid' : '' }}" type="text" name="facciata" id="facciata" value="{{ old('facciata', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fabbricato') ? 'is-invalid' : '' }}" type="text" name="fabbricato" id="fabbricato" value="{{ old('fabbricato', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unita_totali') ? 'is-invalid' : '' }}" type="text" name="unita_totali" id="unita_totali" value="{{ old('unita_totali', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('descrizione_immobile') ? 'is-invalid' : '' }}" name="descrizione_immobile" id="descrizione_immobile">{!! old('descrizione_immobile') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('opere_rinnovi') ? 'is-invalid' : '' }}" name="opere_rinnovi" id="opere_rinnovi">{!! old('opere_rinnovi') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('classe_energetica') ? 'is-invalid' : '' }}" name="classe_energetica" id="classe_energetica">
                    ...
                    @foreach(App\Immobile::CLASSE_ENERGETICA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('classe_energetica', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('piano_ids') ? 'is-invalid' : '' }}" type="text" name="piano_ids" id="piano_ids" value="{{ old('piano_ids', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('piano') ? 'is-invalid' : '' }}" type="text" name="piano" id="piano" value="{{ old('piano', '') }}">
                @if($errors->has('piano'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ma_0') ? 'is-invalid' : '' }}" type="text" name="ma_0" id="ma_0" value="{{ old('ma_0', '') }}">
                @if($errors->has('ma_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ma_1') ? 'is-invalid' : '' }}" type="text" name="ma_1" id="ma_1" value="{{ old('ma_1', '') }}">
                @if($errors->has('ma_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ma_2') ? 'is-invalid' : '' }}" type="text" name="ma_2" id="ma_2" value="{{ old('ma_2', '') }}">
                @if($errors->has('ma_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ma_3') ? 'is-invalid' : '' }}" type="text" name="ma_3" id="ma_3" value="{{ old('ma_3', '') }}">
                @if($errors->has('ma_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mb_0') ? 'is-invalid' : '' }}" type="text" name="mb_0" id="mb_0" value="{{ old('mb_0', '') }}">
                @if($errors->has('mb_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mb_1') ? 'is-invalid' : '' }}" type="text" name="mb_1" id="mb_1" value="{{ old('mb_1', '') }}">
                @if($errors->has('mb_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mb_2') ? 'is-invalid' : '' }}" type="text" name="mb_2" id="mb_2" value="{{ old('mb_2', '') }}">
                @if($errors->has('mb_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mb_3') ? 'is-invalid' : '' }}" type="text" name="mb_3" id="mb_3" value="{{ old('mb_3', '') }}">
                @if($errors->has('mb_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mc_0') ? 'is-invalid' : '' }}" type="text" name="mc_0" id="mc_0" value="{{ old('mc_0', '') }}">
                @if($errors->has('mc_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mc_1') ? 'is-invalid' : '' }}" type="text" name="mc_1" id="mc_1" value="{{ old('mc_1', '') }}">
                @if($errors->has('mc_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mc_2') ? 'is-invalid' : '' }}" type="text" name="mc_2" id="mc_2" value="{{ old('mc_2', '') }}">
                @if($errors->has('mc_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mc_3') ? 'is-invalid' : '' }}" type="text" name="mc_3" id="mc_3" value="{{ old('mc_3', '') }}">
                @if($errors->has('mc_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('md_0') ? 'is-invalid' : '' }}" type="text" name="md_0" id="md_0" value="{{ old('md_0', '') }}">
                @if($errors->has('md_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('md_1') ? 'is-invalid' : '' }}" type="text" name="md_1" id="md_1" value="{{ old('md_1', '') }}">
                @if($errors->has('md_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('md_2') ? 'is-invalid' : '' }}" type="text" name="md_2" id="md_2" value="{{ old('md_2', '') }}">
                @if($errors->has('md_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('md_3') ? 'is-invalid' : '' }}" type="text" name="md_3" id="md_3" value="{{ old('md_3', '') }}">
                @if($errors->has('md_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('me_0') ? 'is-invalid' : '' }}" type="text" name="me_0" id="me_0" value="{{ old('me_0', '') }}">
                @if($errors->has('me_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('me_1') ? 'is-invalid' : '' }}" type="text" name="me_1" id="me_1" value="{{ old('me_1', '') }}">
                @if($errors->has('me_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('me_2') ? 'is-invalid' : '' }}" type="text" name="me_2" id="me_2" value="{{ old('me_2', '') }}">
                @if($errors->has('me_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('me_3') ? 'is-invalid' : '' }}" type="text" name="me_3" id="me_3" value="{{ old('me_3', '') }}">
                @if($errors->has('me_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mf_0') ? 'is-invalid' : '' }}" type="text" name="mf_0" id="mf_0" value="{{ old('mf_0', '') }}">
                @if($errors->has('mf_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mf_1') ? 'is-invalid' : '' }}" type="text" name="mf_1" id="mf_1" value="{{ old('mf_1', '') }}">
                @if($errors->has('mf_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mf_2') ? 'is-invalid' : '' }}" type="text" name="mf_2" id="mf_2" value="{{ old('mf_2', '') }}">
                @if($errors->has('mf_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mf_3') ? 'is-invalid' : '' }}" type="text" name="mf_3" id="mf_3" value="{{ old('mf_3', '') }}">
                @if($errors->has('mf_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mg_0') ? 'is-invalid' : '' }}" type="text" name="mg_0" id="mg_0" value="{{ old('mg_0', '') }}">
                @if($errors->has('mg_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mg_1') ? 'is-invalid' : '' }}" type="text" name="mg_1" id="mg_1" value="{{ old('mg_1', '') }}">
                @if($errors->has('mg_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mg_2') ? 'is-invalid' : '' }}" type="text" name="mg_2" id="mg_2" value="{{ old('mg_2', '') }}">
                @if($errors->has('mg_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mg_3') ? 'is-invalid' : '' }}" type="text" name="mg_3" id="mg_3" value="{{ old('mg_3', '') }}">
                @if($errors->has('mg_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mh_0') ? 'is-invalid' : '' }}" type="text" name="mh_0" id="mh_0" value="{{ old('mh_0', '') }}">
                @if($errors->has('mh_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mh_1') ? 'is-invalid' : '' }}" type="text" name="mh_1" id="mh_1" value="{{ old('mh_1', '') }}">
                @if($errors->has('mh_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mh_2') ? 'is-invalid' : '' }}" type="text" name="mh_2" id="mh_2" value="{{ old('mh_2', '') }}">
                @if($errors->has('mh_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mh_3') ? 'is-invalid' : '' }}" type="text" name="mh_3" id="mh_3" value="{{ old('mh_3', '') }}">
                @if($errors->has('mh_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mi_0') ? 'is-invalid' : '' }}" type="text" name="mi_0" id="mi_0" value="{{ old('mi_0', '') }}">
                @if($errors->has('mi_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mi_1') ? 'is-invalid' : '' }}" type="text" name="mi_1" id="mi_1" value="{{ old('mi_1', '') }}">
                @if($errors->has('mi_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mi_2') ? 'is-invalid' : '' }}" type="text" name="mi_2" id="mi_2" value="{{ old('mi_2', '') }}">
                @if($errors->has('mi_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mi_3') ? 'is-invalid' : '' }}" type="text" name="mi_3" id="mi_3" value="{{ old('mi_3', '') }}">
                @if($errors->has('mi_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ml_0') ? 'is-invalid' : '' }}" type="text" name="ml_0" id="ml_0" value="{{ old('ml_0', '') }}">
                @if($errors->has('ml_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ml_1') ? 'is-invalid' : '' }}" type="text" name="ml_1" id="ml_1" value="{{ old('ml_1', '') }}">
                @if($errors->has('ml_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ml_2') ? 'is-invalid' : '' }}" type="text" name="ml_2" id="ml_2" value="{{ old('ml_2', '') }}">
                @if($errors->has('ml_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ml_3') ? 'is-invalid' : '' }}" type="text" name="ml_3" id="ml_3" value="{{ old('ml_3', '') }}">
                @if($errors->has('ml_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mm_0') ? 'is-invalid' : '' }}" type="text" name="mm_0" id="mm_0" value="{{ old('mm_0', '') }}">
                @if($errors->has('mm_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mm_1') ? 'is-invalid' : '' }}" type="text" name="mm_1" id="mm_1" value="{{ old('mm_1', '') }}">
                @if($errors->has('mm_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mm_2') ? 'is-invalid' : '' }}" type="text" name="mm_2" id="mm_2" value="{{ old('mm_2', '') }}">
                @if($errors->has('mm_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mm_3') ? 'is-invalid' : '' }}" type="text" name="mm_3" id="mm_3" value="{{ old('mm_3', '') }}">
                @if($errors->has('mm_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mn_0') ? 'is-invalid' : '' }}" type="text" name="mn_0" id="mn_0" value="{{ old('mn_0', '') }}">
                @if($errors->has('mn_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mn_1') ? 'is-invalid' : '' }}" type="text" name="mn_1" id="mn_1" value="{{ old('mn_1', '') }}">
                @if($errors->has('mn_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mn_2') ? 'is-invalid' : '' }}" type="text" name="mn_2" id="mn_2" value="{{ old('mn_2', '') }}">
                @if($errors->has('mn_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mn_3') ? 'is-invalid' : '' }}" type="text" name="mn_3" id="mn_3" value="{{ old('mn_3', '') }}">
                @if($errors->has('mn_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mo_0') ? 'is-invalid' : '' }}" type="text" name="mo_0" id="mo_0" value="{{ old('mo_0', '') }}">
                @if($errors->has('mo_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mo_1') ? 'is-invalid' : '' }}" type="text" name="mo_1" id="mo_1" value="{{ old('mo_1', '') }}">
                @if($errors->has('mo_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mo_2') ? 'is-invalid' : '' }}" type="text" name="mo_2" id="mo_2" value="{{ old('mo_2', '') }}">
                @if($errors->has('mo_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mo_3') ? 'is-invalid' : '' }}" type="text" name="mo_3" id="mo_3" value="{{ old('mo_3', '') }}">
                @if($errors->has('mo_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mp_0') ? 'is-invalid' : '' }}" type="text" name="mp_0" id="mp_0" value="{{ old('mp_0', '') }}">
                @if($errors->has('mp_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mp_1') ? 'is-invalid' : '' }}" type="text" name="mp_1" id="mp_1" value="{{ old('mp_1', '') }}">
                @if($errors->has('mp_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mp_2') ? 'is-invalid' : '' }}" type="text" name="mp_2" id="mp_2" value="{{ old('mp_2', '') }}">
                @if($errors->has('mp_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mp_3') ? 'is-invalid' : '' }}" type="text" name="mp_3" id="mp_3" value="{{ old('mp_3', '') }}">
                @if($errors->has('mp_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mq_0') ? 'is-invalid' : '' }}" type="text" name="mq_0" id="mq_0" value="{{ old('mq_0', '') }}">
                @if($errors->has('mq_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mq_1') ? 'is-invalid' : '' }}" type="text" name="mq_1" id="mq_1" value="{{ old('mq_1', '') }}">
                @if($errors->has('mq_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mq_2') ? 'is-invalid' : '' }}" type="text" name="mq_2" id="mq_2" value="{{ old('mq_2', '') }}">
                @if($errors->has('mq_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mq_3') ? 'is-invalid' : '' }}" type="text" name="mq_3" id="mq_3" value="{{ old('mq_3', '') }}">
                @if($errors->has('mq_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mr_0') ? 'is-invalid' : '' }}" type="text" name="mr_0" id="mr_0" value="{{ old('mr_0', '') }}">
                @if($errors->has('mr_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mr_1') ? 'is-invalid' : '' }}" type="text" name="mr_1" id="mr_1" value="{{ old('mr_1', '') }}">
                @if($errors->has('mr_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mr_2') ? 'is-invalid' : '' }}" type="text" name="mr_2" id="mr_2" value="{{ old('mr_2', '') }}">
                @if($errors->has('mr_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mr_3') ? 'is-invalid' : '' }}" type="text" name="mr_3" id="mr_3" value="{{ old('mr_3', '') }}">
                @if($errors->has('mr_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_0') ? 'is-invalid' : '' }}" type="text" name="ms_0" id="ms_0" value="{{ old('ms_0', '') }}">
                @if($errors->has('ms_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_1') ? 'is-invalid' : '' }}" type="text" name="ms_1" id="ms_1" value="{{ old('ms_1', '') }}">
                @if($errors->has('ms_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_2') ? 'is-invalid' : '' }}" type="text" name="ms_2" id="ms_2" value="{{ old('ms_2', '') }}">
                @if($errors->has('ms_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ms_3') ? 'is-invalid' : '' }}" type="text" name="ms_3" id="ms_3" value="{{ old('ms_3', '') }}">
                @if($errors->has('ms_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mt_0') ? 'is-invalid' : '' }}" type="text" name="mt_0" id="mt_0" value="{{ old('mt_0', '') }}">
                @if($errors->has('mt_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mt_1') ? 'is-invalid' : '' }}" type="text" name="mt_1" id="mt_1" value="{{ old('mt_1', '') }}">
                @if($errors->has('mt_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mt_2') ? 'is-invalid' : '' }}" type="text" name="mt_2" id="mt_2" value="{{ old('mt_2', '') }}">
                @if($errors->has('mt_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mt_3') ? 'is-invalid' : '' }}" type="text" name="mt_3" id="mt_3" value="{{ old('mt_3', '') }}">
                @if($errors->has('mt_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mu_0') ? 'is-invalid' : '' }}" type="text" name="mu_0" id="mu_0" value="{{ old('mu_0', '') }}">
                @if($errors->has('mu_0'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mu_1') ? 'is-invalid' : '' }}" type="text" name="mu_1" id="mu_1" value="{{ old('mu_1', '') }}">
                @if($errors->has('mu_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mu_2') ? 'is-invalid' : '' }}" type="text" name="mu_2" id="mu_2" value="{{ old('mu_2', '') }}">
                @if($errors->has('mu_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mu_3') ? 'is-invalid' : '' }}" type="text" name="mu_3" id="mu_3" value="{{ old('mu_3', '') }}">
                @if($errors->has('mu_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mtotale_01') ? 'is-invalid' : '' }}" type="text" name="mtotale_01" id="mtotale_01" value="{{ old('mtotale_01', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mtotale_02') ? 'is-invalid' : '' }}" type="text" name="mtotale_02" id="mtotale_02" value="{{ old('mtotale_02', '') }}">
