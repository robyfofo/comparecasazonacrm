...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.fattura.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.fatturas.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="cliente_nome">{{ trans('cruds.fattura.fields.cliente_nome') }}</label>
                <input class="form-control {{ $errors->has('cliente_nome') ? 'is-invalid' : '' }}" type="text" name="cliente_nome" id="cliente_nome" value="{{ old('cliente_nome', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cliente_cognome') ? 'is-invalid' : '' }}" type="text" name="cliente_cognome" id="cliente_cognome" value="{{ old('cliente_cognome', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cliente_ragione_sociale') ? 'is-invalid' : '' }}" type="text" name="cliente_ragione_sociale" id="cliente_ragione_sociale" value="{{ old('cliente_ragione_sociale', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cliente_codice_fiscale') ? 'is-invalid' : '' }}" type="text" name="cliente_codice_fiscale" id="cliente_codice_fiscale" value="{{ old('cliente_codice_fiscale', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cliente_partita_iva') ? 'is-invalid' : '' }}" type="text" name="cliente_partita_iva" id="cliente_partita_iva" value="{{ old('cliente_partita_iva', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cliente_indirizzo') ? 'is-invalid' : '' }}" type="text" name="cliente_indirizzo" id="cliente_indirizzo" value="{{ old('cliente_indirizzo', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('filiale_agenzia_nome') ? 'is-invalid' : '' }}" type="text" name="filiale_agenzia_nome" id="filiale_agenzia_nome" value="{{ old('filiale_agenzia_nome', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fattura_numero') ? 'is-invalid' : '' }}" type="text" name="fattura_numero" id="fattura_numero" value="{{ old('fattura_numero', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fattura_anno') ? 'is-invalid' : '' }}" type="number" name="fattura_anno" id="fattura_anno" value="{{ old('fattura_anno', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data_emissione') ? 'is-invalid' : '' }}" type="text" name="data_emissione" id="data_emissione" value="{{ old('data_emissione') }}" required>
