    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.admin-settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alert_pratica_scadenza_incarico') ? 'is-invalid' : '' }}" type="number" name="alert_pratica_scadenza_incarico" id="alert_pratica_scadenza_incarico" value="{{ old('alert_pratica_scadenza_incarico', '24') }}" step="1">
            ...
            <div class="form-group">
                ...
                @foreach(App\AdminSetting::ALERT_PRATICA_SCADENZA_INCARICO_ON_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('alert_pratica_scadenza_incarico_on') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="alert_pratica_scadenza_incarico_on_{{ $key }}" name="alert_pratica_scadenza_incarico_on" value="{{ $key }}" {{ old('alert_pratica_scadenza_incarico_on', '1') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alert_appuntamento') ? 'is-invalid' : '' }}" type="number" name="alert_appuntamento" id="alert_appuntamento" value="{{ old('alert_appuntamento', '24') }}" step="1">
            ...
            <div class="form-group">
                ...
                @foreach(App\AdminSetting::ALERT_APPUNTAMENTO_ON_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('alert_appuntamento_on') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="alert_appuntamento_on_{{ $key }}" name="alert_appuntamento_on" value="{{ $key }}" {{ old('alert_appuntamento_on', '1') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alert_pratica_scadenza_affitto') ? 'is-invalid' : '' }}" type="number" name="alert_pratica_scadenza_affitto" id="alert_pratica_scadenza_affitto" value="{{ old('alert_pratica_scadenza_affitto', '30') }}" step="1">
            ...
            <div class="form-group">
                ...
                @foreach(App\AdminSetting::ALERT_PRATICA_SCADENZA_AFFITTO_ON_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('alert_pratica_scadenza_affitto_on') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="alert_pratica_scadenza_affitto_on_{{ $key }}" name="alert_pratica_scadenza_affitto_on" value="{{ $key }}" {{ old('alert_pratica_scadenza_affitto_on', '1') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('obiettivo_venduto') ? 'is-invalid' : '' }}" type="number" name="obiettivo_venduto" id="obiettivo_venduto" value="{{ old('obiettivo_venduto', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('obiettivo_profitto') ? 'is-invalid' : '' }}" type="number" name="obiettivo_profitto" id="obiettivo_profitto" value="{{ old('obiettivo_profitto', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                @foreach(App\AdminSetting::ALERT_RICHIAMATA_CLIENTE_ON_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('alert_richiamata_cliente_on') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="alert_richiamata_cliente_on_{{ $key }}" name="alert_richiamata_cliente_on" value="{{ $key }}" {{ old('alert_richiamata_cliente_on', '1') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alert_richiamata_cliente') ? 'is-invalid' : '' }}" type="number" name="alert_richiamata_cliente" id="alert_richiamata_cliente" value="{{ old('alert_richiamata_cliente', '24') }}" step="1">
