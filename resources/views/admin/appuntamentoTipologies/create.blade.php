...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.appuntamentoTipologie.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.appuntamento-tipologies.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pos') ? 'is-invalid' : '' }}" type="number" name="pos" id="pos" value="{{ old('pos', '') }}" step="1" required>
                @if($errors->has('pos'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bgcolor') ? 'is-invalid' : '' }}" type="text" name="bgcolor" id="bgcolor" value="{{ old('bgcolor', '') }}">
