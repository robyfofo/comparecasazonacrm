...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.agentClient.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.agent-clients.update", [$agentClient->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('agente') ? 'is-invalid' : '' }}" name="agente_id" id="agente_id" required>
                    @foreach($agentes as $id => $agente)
                        <option value="{{ $id }}" {{ ($agentClient->agente ? $agentClient->agente->id : old('agente_id')) == $id ? 'selected' : '' }}>{{ $agente }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('filiale') ? 'is-invalid' : '' }}" name="filiale_id" id="filiale_id" required>
                    @foreach($filiales as $id => $filiale)
                        <option value="{{ $id }}" {{ ($agentClient->filiale ? $agentClient->filiale->id : old('filiale_id')) == $id ? 'selected' : '' }}>{{ $filiale }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('tipo') ? 'is-invalid' : '' }}" name="tipo_id" id="tipo_id">
                    @foreach($tipos as $id => $tipo)
                        <option value="{{ $id }}" {{ ($agentClient->tipo ? $agentClient->tipo->id : old('tipo_id')) == $id ? 'selected' : '' }}>{{ $tipo }}</option>
                    @endforeach
                </select>
                @if($errors->has('tipo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ruolo') ? 'is-invalid' : '' }}" type="text" name="ruolo" id="ruolo" value="{{ old('ruolo', $agentClient->ruolo) }}">
                @if($errors->has('ruolo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('settore') ? 'is-invalid' : '' }}" type="text" name="settore" id="settore" value="{{ old('settore', $agentClient->settore) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('indirizzo') ? 'is-invalid' : '' }}" type="text" name="indirizzo" id="indirizzo" value="{{ old('indirizzo', $agentClient->indirizzo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('civico') ? 'is-invalid' : '' }}" type="text" name="civico" id="civico" value="{{ old('civico', $agentClient->civico) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cap') ? 'is-invalid' : '' }}" type="text" name="cap" id="cap" value="{{ old('cap', $agentClient->cap) }}">
                @if($errors->has('cap'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('comune') ? 'is-invalid' : '' }}" name="comune_id" id="comune_id">
                    @foreach($comunes as $id => $comune)
                        <option value="{{ $id }}" {{ ($agentClient->comune ? $agentClient->comune->id : old('comune_id')) == $id ? 'selected' : '' }}>{{ $comune }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('provincia') ? 'is-invalid' : '' }}" name="provincia_id" id="provincia_id">
                    @foreach($provincias as $id => $provincia)
                        <option value="{{ $id }}" {{ ($agentClient->provincia ? $agentClient->provincia->id : old('provincia_id')) == $id ? 'selected' : '' }}>{{ $provincia }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('azienda') ? 'is-invalid' : '' }}" type="text" name="azienda" id="azienda" value="{{ old('azienda', $agentClient->azienda) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('piva') ? 'is-invalid' : '' }}" type="text" name="piva" id="piva" value="{{ old('piva', $agentClient->piva) }}">
                @if($errors->has('piva'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono') ? 'is-invalid' : '' }}" type="text" name="telefono" id="telefono" value="{{ old('telefono', $agentClient->telefono) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cellulare') ? 'is-invalid' : '' }}" type="text" name="cellulare" id="cellulare" value="{{ old('cellulare', $agentClient->cellulare) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fax') ? 'is-invalid' : '' }}" type="text" name="fax" id="fax" value="{{ old('fax', $agentClient->fax) }}">
                @if($errors->has('fax'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('livello') ? 'is-invalid' : '' }}" type="text" name="livello" id="livello" value="{{ old('livello', $agentClient->livello) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('note') ? 'is-invalid' : '' }}" name="note" id="note">{{ old('note', $agentClient->note) }}</textarea>
                @if($errors->has('note'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('birthday') ? 'is-invalid' : '' }}" type="text" name="birthday" id="birthday" value="{{ old('birthday', $agentClient->birthday) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nazione') ? 'is-invalid' : '' }}" type="text" name="nazione" id="nazione" value="{{ old('nazione', $agentClient->nazione) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nome_2') ? 'is-invalid' : '' }}" type="text" name="nome_2" id="nome_2" value="{{ old('nome_2', $agentClient->nome_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cognome_2') ? 'is-invalid' : '' }}" type="text" name="cognome_2" id="cognome_2" value="{{ old('cognome_2', $agentClient->cognome_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('affinita') ? 'is-invalid' : '' }}" type="text" name="affinita" id="affinita" value="{{ old('affinita', $agentClient->affinita) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_2') ? 'is-invalid' : '' }}" type="text" name="email_2" id="email_2" value="{{ old('email_2', $agentClient->email_2) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('comune_2') ? 'is-invalid' : '' }}" name="comune_2_id" id="comune_2_id">
                    @foreach($comune_2s as $id => $comune_2)
                        <option value="{{ $id }}" {{ ($agentClient->comune_2 ? $agentClient->comune_2->id : old('comune_2_id')) == $id ? 'selected' : '' }}>{{ $comune_2 }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('prov_2') ? 'is-invalid' : '' }}" name="prov_2_id" id="prov_2_id">
                    @foreach($prov_2s as $id => $prov_2)
                        <option value="{{ $id }}" {{ ($agentClient->prov_2 ? $agentClient->prov_2->id : old('prov_2_id')) == $id ? 'selected' : '' }}>{{ $prov_2 }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('indirizzo_2') ? 'is-invalid' : '' }}" type="text" name="indirizzo_2" id="indirizzo_2" value="{{ old('indirizzo_2', $agentClient->indirizzo_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('civico_2') ? 'is-invalid' : '' }}" type="text" name="civico_2" id="civico_2" value="{{ old('civico_2', $agentClient->civico_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cap_2') ? 'is-invalid' : '' }}" type="text" name="cap_2" id="cap_2" value="{{ old('cap_2', $agentClient->cap_2) }}">
                @if($errors->has('cap_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono_2') ? 'is-invalid' : '' }}" type="text" name="telefono_2" id="telefono_2" value="{{ old('telefono_2', $agentClient->telefono_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cellulare_2') ? 'is-invalid' : '' }}" type="text" name="cellulare_2" id="cellulare_2" value="{{ old('cellulare_2', $agentClient->cellulare_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fax_2') ? 'is-invalid' : '' }}" type="text" name="fax_2" id="fax_2" value="{{ old('fax_2', $agentClient->fax_2) }}">
                @if($errors->has('fax_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stato') ? 'is-invalid' : '' }}" type="number" name="stato" id="stato" value="{{ old('stato', $agentClient->stato) }}" step="1">
                @if($errors->has('stato'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_istituzionale') ? 'is-invalid' : '' }}" type="email" name="email_istituzionale" id="email_istituzionale" value="{{ old('email_istituzionale', $agentClient->email_istituzionale) }}">
