...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.filiali.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.filialis.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_pec') ? 'is-invalid' : '' }}" type="email" name="email_pec" id="email_pec" value="{{ old('email_pec') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('codice_fiscale') ? 'is-invalid' : '' }}" type="text" name="codice_fiscale" id="codice_fiscale" value="{{ old('codice_fiscale', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('partita_iva') ? 'is-invalid' : '' }}" type="text" name="partita_iva" id="partita_iva" value="{{ old('partita_iva', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ccia_numero_rea') ? 'is-invalid' : '' }}" type="text" name="ccia_numero_rea" id="ccia_numero_rea" value="{{ old('ccia_numero_rea', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('capitale_sociale') ? 'is-invalid' : '' }}" type="number" name="capitale_sociale" id="capitale_sociale" value="{{ old('capitale_sociale', '') }}" step="0.01">
