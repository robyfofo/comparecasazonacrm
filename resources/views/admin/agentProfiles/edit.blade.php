...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.agentProfile.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.agent-profiles.update", [$agentProfile->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="nome">{{ trans('cruds.agentProfile.fields.nome') }}</label>
                <input class="form-control {{ $errors->has('nome') ? 'is-invalid' : '' }}" type="text" name="nome" id="nome" value="{{ old('nome', $agentProfile->nome) }}" required>
                @if($errors->has('nome'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('indirizzo') ? 'is-invalid' : '' }}" type="text" name="indirizzo" id="indirizzo" value="{{ old('indirizzo', $agentProfile->indirizzo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cap') ? 'is-invalid' : '' }}" type="number" name="cap" id="cap" value="{{ old('cap', $agentProfile->cap) }}" step="1">
                @if($errors->has('cap'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono') ? 'is-invalid' : '' }}" type="text" name="telefono" id="telefono" value="{{ old('telefono', $agentProfile->telefono) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cellulare') ? 'is-invalid' : '' }}" type="text" name="cellulare" id="cellulare" value="{{ old('cellulare', $agentProfile->cellulare) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fax') ? 'is-invalid' : '' }}" type="text" name="fax" id="fax" value="{{ old('fax', $agentProfile->fax) }}">
                @if($errors->has('fax'))
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('lunedi_inizio') ? 'is-invalid' : '' }}" type="text" name="lunedi_inizio" id="lunedi_inizio" value="{{ old('lunedi_inizio', $agentProfile->lunedi_inizio) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('lunedi_fine') ? 'is-invalid' : '' }}" type="text" name="lunedi_fine" id="lunedi_fine" value="{{ old('lunedi_fine', $agentProfile->lunedi_fine) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('martedi_inizio') ? 'is-invalid' : '' }}" type="text" name="martedi_inizio" id="martedi_inizio" value="{{ old('martedi_inizio', $agentProfile->martedi_inizio) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('martedi_fine') ? 'is-invalid' : '' }}" type="text" name="martedi_fine" id="martedi_fine" value="{{ old('martedi_fine', $agentProfile->martedi_fine) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('mercoledi_inizio') ? 'is-invalid' : '' }}" type="text" name="mercoledi_inizio" id="mercoledi_inizio" value="{{ old('mercoledi_inizio', $agentProfile->mercoledi_inizio) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('mercoledi_fine') ? 'is-invalid' : '' }}" type="text" name="mercoledi_fine" id="mercoledi_fine" value="{{ old('mercoledi_fine', $agentProfile->mercoledi_fine) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('giovedi_inizio') ? 'is-invalid' : '' }}" type="text" name="giovedi_inizio" id="giovedi_inizio" value="{{ old('giovedi_inizio', $agentProfile->giovedi_inizio) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('giovedi_fine') ? 'is-invalid' : '' }}" type="text" name="giovedi_fine" id="giovedi_fine" value="{{ old('giovedi_fine', $agentProfile->giovedi_fine) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('venerdi_inizio') ? 'is-invalid' : '' }}" type="text" name="venerdi_inizio" id="venerdi_inizio" value="{{ old('venerdi_inizio', $agentProfile->venerdi_inizio) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('venerdi_fine') ? 'is-invalid' : '' }}" type="text" name="venerdi_fine" id="venerdi_fine" value="{{ old('venerdi_fine', $agentProfile->venerdi_fine) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('sabato_inizio') ? 'is-invalid' : '' }}" type="text" name="sabato_inizio" id="sabato_inizio" value="{{ old('sabato_inizio', $agentProfile->sabato_inizio) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('sabato_fine') ? 'is-invalid' : '' }}" type="text" name="sabato_fine" id="sabato_fine" value="{{ old('sabato_fine', $agentProfile->sabato_fine) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('domenica_inizio') ? 'is-invalid' : '' }}" type="text" name="domenica_inizio" id="domenica_inizio" value="{{ old('domenica_inizio', $agentProfile->domenica_inizio) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('domenica_fine') ? 'is-invalid' : '' }}" type="text" name="domenica_fine" id="domenica_fine" value="{{ old('domenica_fine', $agentProfile->domenica_fine) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('comune') ? 'is-invalid' : '' }}" name="comune_id" id="comune_id">
                    @foreach($comunes as $id => $comune)
                        <option value="{{ $id }}" {{ ($agentProfile->comune ? $agentProfile->comune->id : old('comune_id')) == $id ? 'selected' : '' }}>{{ $comune }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('filiale') ? 'is-invalid' : '' }}" name="filiale_id" id="filiale_id">
                    @foreach($filiales as $id => $filiale)
                        <option value="{{ $id }}" {{ ($agentProfile->filiale ? $agentProfile->filiale->id : old('filiale_id')) == $id ? 'selected' : '' }}>{{ $filiale }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_istituzionale') ? 'is-invalid' : '' }}" type="email" name="email_istituzionale" id="email_istituzionale" value="{{ old('email_istituzionale', $agentProfile->email_istituzionale) }}">
