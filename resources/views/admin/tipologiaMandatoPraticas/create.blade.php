...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.tipologiaMandatoPratica.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tipologia-mandato-praticas.store") }}" enctype="multipart/form-data">
            @csrf
